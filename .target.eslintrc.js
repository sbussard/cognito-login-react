module.exports = {
  ...
  "rules": {
    ...
    "no-warning-comments": [1, { "terms": ["todo", "fixme", "xxx"], "location": "start" }], // http://eslint.org/docs/rules/no-warning-comments
    ...
    "id-length": [2, {"min": 1, "max": 100, "properties": "always", "exceptions": []}], // http://eslint.org/docs/rules/id-length
    ...
    "arrow-spacing" : [2, { "before": true, "after": true }], // http://eslint.org/docs/rules/arrow-parens
